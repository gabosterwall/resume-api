    ...
    <>
      <div className='w-full h-[100vh] bg-gray-700 flex flex-col items-center pt-24'>
        <div className='w-[60%] h-auto bg-gray-400 border-none rounded-sm shadow-md shadow-stone-800 p-2'>
          ...
          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eveniet aspernatur quidem ut natus! Delectus debitis labore repellat hic necessitatibus similique non sint nulla, dolore ipsam excepturi sed, voluptatem velit natus.
          </p>
        </div>
      </div>
    </>
